...
plot(max_ntr,'Color',proj.param.plot.light_grey,'LineWidth', 2);
plot(min_ntr,'Color',proj.param.plot.light_grey,'LineWidth',2);
plot(mu_ntr,'Color',proj.param.plot.light_grey,'LineWidth',3);

plot(max_pos,'r-','LineWidth',2);
plot(min_pos,'r-','LineWidth',2);
plot(mu_pos,'r-','LineWidth',3);

plot(max_neg,'b-','LineWidth',2);
plot(min_neg,'b-','LineWidth',2);
plot(mu_neg,'b-','LineWidth',3);
...
for i=1:numel(sig_subjs)
    mu_traj_v = [mu_traj_v;sig_subjs{i}.mu_traj_v];
end
...
export_fig 'VR_v_dyna_extr_subjs.png' -r300  
eval(['! mv ',proj.path.code,'VR_v_dyna_extr_subjs.png ', ...
      proj.path.fig]);

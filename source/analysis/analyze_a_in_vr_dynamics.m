...
for i = 1:numel(subjs)
    ...
    try
        ...
        if(isfield(prds,'a_dcmp'))
            ...
            h = prds.a_dcmp.h(:,4:6);
            h_n1 = prds.a_dcmp.h(:,3:5);
            dh = prds.a_dcmp.dh(:,2:4); %b/c of pruning for drv
            d2h = prds.a_dcmp.d2h(:,1:3); %b/c of pruning for 2nd drv
...
fe_a_re_1 = compare(mdl_fe_1,mdl_re_1);
fe_a_re_2 = compare(mdl_fe_2,mdl_re_2);
fe_a_re_3 = compare(mdl_fe_3,mdl_re_3);

mdl_1 = mdl_fe_1;
if(fe_a_re_1.pValue<0.05);
    disp('   -mdl_1 random effects matter');
    mdl_1 = mdl_re_1;
end

mdl_2 = mdl_fe_2;
if(fe_a_re_2.pValue<0.05);
    disp('   -mdl_2 random effects matter');
    mdl_2 = mdl_re_2;
end

mdl_3 = mdl_fe_3;
if(fe_a_re_3.pValue<0.05);

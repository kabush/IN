...
logger(['Computing IN Cog Control PRO Models                  '],proj.path.logfile);
logger(['*************************************************'],proj.path.logfile);

%% ----------------------------------------
%% Set-up Directory Structure for fMRI betas
if(proj.flag.clean_build)
    disp(['Removing ',proj.path.ctrl.in_pro_mdl]);
    eval(['! rm -rf ',proj.path.ctrl.in_pro_mdl]);
    disp(['Creating ',proj.path.ctrl.in_pro_mdl]);
    eval(['! mkdir ',proj.path.ctrl.in_pro_mdl]);
end

...
% 
% %% ----------------------------------------
% %% STEP 4: Validate EX & IN predictions (Platt scaled)
% mvpa_fmri_ex_via_ex_gm_mdl; % comment here
% mvpa_fmri_in_via_ex_gm_mdl; % comment here
% 
% %% ----------------------------------------
% %% STEP 5: Compute Intrinsic Neuromodulation Dynamics
% dynamics_fmri_in_gm;
% 
% %% ----------------------------------------
% %% STEP 6: Run quality check (system) on dynamics
% % (TBD)
% 
% %% ----------------------------------------
% %% STEP 7: Test significance of VR effect (output figs)
% analyze_in_skill;
% 
% %% ----------------------------------------
